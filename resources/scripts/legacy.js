...
// Create resize function that only changes stuff upon large resize AND resizing to a size larger than before.
// Adjust star count (some sizes are too much)
// Adjust opacity?
// Adjust radius and (maybe) velocity based on screen size
